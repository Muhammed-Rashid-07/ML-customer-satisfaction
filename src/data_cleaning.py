...
class DataPreProcessStrategy (DataStrategy):
    def handle_data(self, data: pd.DataFrame) -> Union[pd.DataFrame,pd.Series]:
        try:
            ...
            data['product_weight_g'].fillna(data["product_length_cm"].median(),inplace=True)
            data['product_weight_g'].fillna(data["product_height_cm"].median(),inplace=True)
            data['product_weight_g'].fillna(data["product_width_cm"].median(),inplace=True)
            data['product_weight_g'].fillna(data["product_width_cm"].median(),inplace=True)
